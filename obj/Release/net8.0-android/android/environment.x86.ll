...
@dso_cache = dso_local local_unnamed_addr global [604 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 189453998, ; hash 0xb4ad6ae, from name: aot-Xamarin.AndroidX.Lifecycle.ViewModel.Android
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 200144911, ; hash 0xbedf80f, from name: Xamarin.AndroidX.Lifecycle.ViewModel.Android.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.44_name, ; name: libaot-Xamarin.AndroidX.Lifecycle.ViewModel.Android.dll.so
		ptr null; void* handle (0x0)
	}, ; 21
	...
	%struct.DSOCacheEntry {
		i64 300118222, ; hash 0x11e370ce, from name: aot-Xamarin.AndroidX.Lifecycle.Common.Jvm
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 319025377, ; hash 0x1303f0e1, from name: Plugin.LocalNotification.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 636057840, ; hash 0x25e978f0, from name: aot-Plugin.LocalNotification
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.24_name, ; name: libaot-Plugin.LocalNotification.dll.so
		ptr null; void* handle (0x0)
	}, ; 83
	...
	%struct.DSOCacheEntry {
		i64 700305214, ; hash 0x29bdcf3e, from name: aot-Plugin.LocalNotification.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.24_name, ; name: libaot-Plugin.LocalNotification.dll.so
		ptr null; void* handle (0x0)
	}, ; 91
	...
	%struct.DSOCacheEntry {
		i64 762103140, ; hash 0x2d6cc564, from name: CapstoneMobileApp.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1100691279, ; hash 0x419b374f, from name: libaot-Xamarin.AndroidX.Lifecycle.Common.Jvm
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.42_name, ; name: libaot-Xamarin.AndroidX.Lifecycle.Common.Jvm.dll.so
		ptr null; void* handle (0x0)
	}, ; 144
	...
	%struct.DSOCacheEntry {
		i64 1286500177, ; hash 0x4cae6f51, from name: libaot-Xamarin.AndroidX.Lifecycle.Common.Jvm.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.42_name, ; name: libaot-Xamarin.AndroidX.Lifecycle.Common.Jvm.dll.so
		ptr null; void* handle (0x0)
	}, ; 163
	...
	%struct.DSOCacheEntry {
		i64 1313840730, ; hash 0x4e4f9e5a, from name: aot-Xamarin.AndroidX.Lifecycle.ViewModel.Android.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.44_name, ; name: libaot-Xamarin.AndroidX.Lifecycle.ViewModel.Android.dll.so
		ptr null; void* handle (0x0)
	}, ; 165
	...
	%struct.DSOCacheEntry {
		i64 1437299793, ; hash 0x55ab7451, from name: Xamarin.AndroidX.Lifecycle.Common.Jvm
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.42_name, ; name: libaot-Xamarin.AndroidX.Lifecycle.Common.Jvm.dll.so
		ptr null; void* handle (0x0)
	}, ; 189
	...
	%struct.DSOCacheEntry {
		i64 1441095154, ; hash 0x55e55df2, from name: Xamarin.AndroidX.Lifecycle.ViewModel.Android
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.44_name, ; name: libaot-Xamarin.AndroidX.Lifecycle.ViewModel.Android.dll.so
		ptr null; void* handle (0x0)
	}, ; 191
	...
	%struct.DSOCacheEntry {
		i64 1651624125, ; hash 0x6271c8bd, from name: libaot-CapstoneMobileApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-CapstoneMobileApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 216
	...
	%struct.DSOCacheEntry {
		i64 1962117045, ; hash 0x74f387b5, from name: libaot-CapstoneMobileApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-CapstoneMobileApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 262
	...
	%struct.DSOCacheEntry {
		i64 2304320104, ; hash 0x89592268, from name: aot-CapstoneMobileApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-CapstoneMobileApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 317
	...
	%struct.DSOCacheEntry {
		i64 2398910401, ; hash 0x8efc77c1, from name: aot-CapstoneMobileApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-CapstoneMobileApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 327
	...
	%struct.DSOCacheEntry {
		i64 2595938267, ; hash 0x9abadfdb, from name: libaot-Xamarin.AndroidX.Lifecycle.ViewModel.Android.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.44_name, ; name: libaot-Xamarin.AndroidX.Lifecycle.ViewModel.Android.dll.so
		ptr null; void* handle (0x0)
	}, ; 358
	...
	%struct.DSOCacheEntry {
		i64 2933999366, ; hash 0xaee14706, from name: CapstoneMobileApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-CapstoneMobileApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 411
	...
	%struct.DSOCacheEntry {
		i64 3225517864, ; hash 0xc0417f28, from name: aot-Xamarin.AndroidX.Lifecycle.Common.Jvm.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.42_name, ; name: libaot-Xamarin.AndroidX.Lifecycle.Common.Jvm.dll.so
		ptr null; void* handle (0x0)
	}, ; 465
	...
	%struct.DSOCacheEntry {
		i64 3506838126, ; hash 0xd1061a6e, from name: Xamarin.AndroidX.Lifecycle.Common.Jvm.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.42_name, ; name: libaot-Xamarin.AndroidX.Lifecycle.Common.Jvm.dll.so
		ptr null; void* handle (0x0)
	}, ; 498
	...
	%struct.DSOCacheEntry {
		i64 3772526445, ; hash 0xe0dc2f6d, from name: libaot-Xamarin.AndroidX.Lifecycle.ViewModel.Android
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.44_name, ; name: libaot-Xamarin.AndroidX.Lifecycle.ViewModel.Android.dll.so
		ptr null; void* handle (0x0)
	}, ; 533
...
@.env.3 = private unnamed_addr constant [37 x i8] c"e7496123-ad96-4221-b65b-4e429f36b645\00", align 1
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [34 x i8] c"com.companyname.capstonemobileapp\00", align 1
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [32 x i8] c"libaot-CapstoneMobileApp.dll.so\00", align 1
...
@.DSOCacheEntry.24_name = private unnamed_addr constant [39 x i8] c"libaot-Plugin.LocalNotification.dll.so\00", align 1
...
@.DSOCacheEntry.41_name = private unnamed_addr constant [48 x i8] c"libaot-Xamarin.AndroidX.Lifecycle.Common.dll.so\00", align 1
...
@.DSOCacheEntry.45_name = private unnamed_addr constant [61 x i8] c"libaot-Xamarin.AndroidX.Lifecycle.ViewModelSavedState.dll.so\00", align 1
@.DSOCacheEntry.46_name = private unnamed_addr constant [38 x i8] c"libaot-Xamarin.AndroidX.Loader.dll.so\00", align 1
@.DSOCacheEntry.47_name = private unnamed_addr constant [49 x i8] c"libaot-Xamarin.AndroidX.Navigation.Common.dll.so\00", align 1
...
@.DSOCacheEntry.49_name = private unnamed_addr constant [50 x i8] c"libaot-Xamarin.AndroidX.Navigation.Runtime.dll.so\00", align 1
...
@.DSOCacheEntry.52_name = private unnamed_addr constant [42 x i8] c"libaot-Xamarin.AndroidX.SavedState.dll.so\00", align 1
...
@.DSOCacheEntry.54_name = private unnamed_addr constant [51 x i8] c"libaot-Xamarin.AndroidX.VersionedParcelable.dll.so\00", align 1
...
@.DSOCacheEntry.58_name = private unnamed_addr constant [46 x i8] c"libaot-Xamarin.GooglePlayServices.Base.dll.so\00", align 1
@.DSOCacheEntry.59_name = private unnamed_addr constant [50 x i8] c"libaot-Xamarin.GooglePlayServices.Basement.dll.so\00", align 1
@.DSOCacheEntry.60_name = private unnamed_addr constant [50 x i8] c"libaot-Xamarin.GooglePlayServices.Location.dll.so\00", align 1
@.DSOCacheEntry.61_name = private unnamed_addr constant [47 x i8] c"libaot-Xamarin.GooglePlayServices.Tasks.dll.so\00", align 1
@.DSOCacheEntry.62_name = private unnamed_addr constant [36 x i8] c"libaot-Xamarin.Kotlin.StdLib.dll.so\00", align 1
@.DSOCacheEntry.63_name = private unnamed_addr constant [50 x i8] c"libaot-Xamarin.KotlinX.Coroutines.Core.Jvm.dll.so\00", align 1
@.DSOCacheEntry.64_name = private unnamed_addr constant [44 x i8] c"libaot-System.Collections.Concurrent.dll.so\00", align 1
@.DSOCacheEntry.65_name = private unnamed_addr constant [43 x i8] c"libaot-System.Collections.Immutable.dll.so\00", align 1
...
@.DSOCacheEntry.73_name = private unnamed_addr constant [45 x i8] c"libaot-System.Diagnostics.TraceSource.dll.so\00", align 1
...
@.DSOCacheEntry.85_name = private unnamed_addr constant [33 x i8] c"libaot-System.Private.Xml.dll.so\00", align 1
@.DSOCacheEntry.86_name = private unnamed_addr constant [64 x i8] c"libaot-System.Runtime.InteropServices.RuntimeInformation.dll.so\00", align 1
